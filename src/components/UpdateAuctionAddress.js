...
function UpdateAuctionAddress() {
    ...
    const setAddress = () => {
        let url = "http://localhost:8080/auction_products/update/auction/" + auction_id +"/address/" + lat + "/" + lng;
                        ...
                        <div className=" col-sm-12">
                            <Card className=" bg-warning.bg-gradient">
                                ...
                                <Card.Body>
                                    ...
                                    <Button className="btn btn-success btn-lg btn-block" onClick={setAddress}> Confirm Address </Button>
...
export default UpdateAuctionAddress;